...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       05/03/2017 19:02
     Generated by:       Daniele Catanesi
     Organization:       http://blog.helocheck.com
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
function Show-About_psf
{
	...
	$form_About_Load = {
		...
		$appVersion = "1.2"
		$appLastUpdate = "Last Update: 2017/03/05"
		...
		$lbl_CreatedWith.Text = "Mail Tr@cker
	Created with Sapien PowerShell Studio 2017"
